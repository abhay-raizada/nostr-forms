...
function DeleteConfirmationLocal({formId, onCancel, onDeleted}: IDeleteFormsLocal) {
    const onDeleteForm = () => {
    ...
    return <Modal title={'Are you sure you want to delete the form?'} open onOk={onDeleteForm} onCancel={onCancel}>
        <p>This action is irreversible</p>
    </Modal>
}

function DeleteFormTrigger({formId, type}: Optional<IDeleteFormsTrigger, "onDeleted" | "onCancel">) {
    const [deleteConfirmationOpen, updateDeleteConfirmationOpen] = useState(false)
